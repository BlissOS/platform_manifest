...
Install repo [repo installation instruction](https://source.android.com/docs/setup/download/downloading#initializing-a-repo-client), `repo` from packages could be too old.
